...
declare namespace EmscriptenModule {
  ...
  function cwrap<TR>(ident: string, returnType: string): () => TR;
  function cwrap<TR, A1>(ident: string, returnType: string, argTypes: [string]): (a1: A1) => TR;
